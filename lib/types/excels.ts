...
export type BGEffectType = 'BG_ScrollT_0.5' | 'BG_Filter_Red' | 'BG_Wave_F' | 'BG_Flash'
  | 'BG_UnderFire_R' | 'BG_Love_L' | 'BG_ScrollB_0.5' | 'BG_Rain_L' | 'BG_UnderFire' | 'BG_WaveShort_F'
  | 'BG_SandStorm_L' | '' | 'BG_ScrollT_1.5' | 'BG_Shining_L' | 'BG_ScrollB_1.0' | 'BG_Love_L_BGOff' | 'BG_Dust_L'
  | 'BG_ScrollL_0.5' | 'BG_ScrollL_1.0' | 'BG_Ash_Black' | 'BG_Mist_L' | 'BG_Flash_Sound' | 'BG_ScrollL_1.5' | 'BG_FocusLine'
  | 'BG_ScrollR_1.5' | 'BG_Shining_L_BGOff' | 'BG_ScrollT_1.0'
  | 'BG_ScrollB_1.5' | 'BG_Filter_Red_BG' | 'BG_Ash_Red' | 'BG_Fireworks_L_BGOff_02' | 'BG_ScrollR_0.5'
